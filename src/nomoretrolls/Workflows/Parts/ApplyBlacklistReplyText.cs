...
{
    internal class ApplyBlacklistReplyText : IMessageWorkflowPart
    {
        private readonly IBlacklistReplyTextGenerator _replyTextGenerator;

        public ApplyBlacklistReplyText(IBlacklistReplyTextGenerator replyTextGenerator)
        {
